...
BOT_TOKEN = environ.get('BOT_TOKEN', '6007401862:AAEEtThWwytBUaKjrWeptQmlB6wSZ2PT5tc')
...
BUTTON_TEXT = is_enabled((environ.get('BUTTON_TEXT', "False")), True)
...
LOG_STR += ("BUTTON_TEXT is Found, filename and files size will be shown in a single button instead of two separate buttons\n" if BUTTON_TEXT else "BUTTON_TEXT is disabled , filename and file_sixe will be shown as different buttons\n")
